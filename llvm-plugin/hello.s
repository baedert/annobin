...
.set _annobin_hello_c_end, .text.zzz
	...
	.byte	2
	.byte	3
	.byte	0	# Stack Proctector Strong 
	.byte	0
	.byte	0	# padding 
	.quad	_annobin_hello_c_start	# start symbol 
	.quad	_annobin_hello_c_end	# end symbol 
...
.Linfo_string0:
	.asciz	"clang version 8.0.0 (Fedora 8.0.0-3.fc30) /usr/bin/clang-8 -Xclang -load -Xclang /home/nickc/work/sources/annobin/llvm-plugin/annobin.so -D _FORTIFY_SOURCE=2 -O2 -g -grecord-command-line -fpic -fcf-protection=full -fstack-protector-strong -fsanitize=safe-stack -fsanitize=cfi-cast-strict hello.c -save-temps=cwd" # string offset=0
.Linfo_string1:
	.asciz	"hello.c"               # string offset=312
.Linfo_string2:
	.asciz	"/home/nickc/work/sources/annobin/llvm-plugin" # string offset=320
.Linfo_string3:
	.asciz	"buf"                   # string offset=365
.Linfo_string4:
	.asciz	"char"                  # string offset=369
.Linfo_string5:
	.asciz	"__ARRAY_SIZE_TYPE__"   # string offset=374
.Linfo_string6:
	.asciz	"strcpy"                # string offset=394
.Linfo_string7:
	.asciz	"__dest"                # string offset=401
.Linfo_string8:
	.asciz	"__src"                 # string offset=408
.Linfo_string9:
	.asciz	"main"                  # string offset=414
.Linfo_string10:
	.asciz	"int"                   # string offset=419
.Linfo_string11:
